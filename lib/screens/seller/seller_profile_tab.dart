          ...
          child: Column(
            ...
            children: [
              ...
              CircleAvatar(
                ...
                child: const Icon(Icons.person, size: 48, color: Color(0xFF2F5233)),
              ),
              ...
              Card(
                ...
                child: Padding(
                  ...
                  child: Column(
                    children: [
                      _ProfileInfoRow(icon: Icons.email, label: 'البريد الإلكتروني', value: data['email'] ?? ''),
                      const Divider(),
                      _ProfileInfoRow(icon: Icons.phone, label: 'رقم الهاتف', value: data['phone'] ?? ''),
                      const Divider(),
                      _ProfileInfoRow(icon: Icons.location_on, label: 'العنوان', value: data['address'] ?? ''),
              ...
              SizedBox(
                ...
                child: ElevatedButton.icon(
                  ...
                  label: const Text('تسجيل الخروج', style: TextStyle(fontSize: 18, fontFamily: 'Cairo')),
